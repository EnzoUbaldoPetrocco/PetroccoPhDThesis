...
\chapter{Cultural Competence in Machine Learning}
\label{ch2}
...
%
In this section, I delineate the social robotics use cases that serve as the primary empirical references for this study. 
Furthermore, I revisit established ML frameworks to formalize a rigorous architecture for culturally competent ML, accompanied by the definition of appropriate evaluation metrics. 
Finally, I propose a suite of mitigation strategies derived from Multi-Task Learning (MTL) and specialized Data Augmentation (DA) techniques designed to address cultural bias in robotic perception. 
%
...
To bridge this gap, we employed the ResNet50 architecture \citep{He_2016_CVPR}, pre-trained on the ImageNet-1k corpus, to serve as a fixed feature extractor.
